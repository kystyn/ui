...
**
** Created: Fri Sep 2 01:14:00 2011
...
static const uint qt_meta_data_QDeclarativeComponent[] = {
 ...
 // properties: name, type, flags
     214,  208, (QMetaType::QReal << 24) | 0x00495001,
     230,  223, 0x00495009,
     242,  237, 0x11095401,
...
const QMetaObject QDeclarativeComponent::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_QDeclarativeComponent,
      qt_meta_data_QDeclarativeComponent, 0 }
};
...
int QDeclarativeComponent::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: statusChanged((*reinterpret_cast< QDeclarativeComponent::Status(*)>(_a[1]))); break;
        case 1: progressChanged((*reinterpret_cast< qreal(*)>(_a[1]))); break;
        case 2: { QString _r = errorString();
            if (_a[0]) *reinterpret_cast< QString*>(_a[0]) = _r; }  break;
        case 3: { QScriptValue _r = createObject((*reinterpret_cast< QObject*(*)>(_a[1])));
            if (_a[0]) *reinterpret_cast< QScriptValue*>(_a[0]) = _r; }  break;
        case 4: { QScriptValue _r = createObject((*reinterpret_cast< QObject*(*)>(_a[1])),(*reinterpret_cast< const QScriptValue(*)>(_a[2])));
            if (_a[0]) *reinterpret_cast< QScriptValue*>(_a[0]) = _r; }  break;
        default: ;
        }
        _id -= 5;
