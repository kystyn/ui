...
**
** Created: Fri Sep 2 01:12:36 2011
...
static const uint qt_meta_data_QDeclarativeSpringAnimation[] = {
 ...
 // properties: name, type, flags
      80,   74, (QMetaType::QReal << 24) | 0x00095103,
      89,   74, (QMetaType::QReal << 24) | 0x00095103,
      96,   74, (QMetaType::QReal << 24) | 0x00095103,
     104,   74, (QMetaType::QReal << 24) | 0x00095103,
     112,   74, (QMetaType::QReal << 24) | 0x00495103,
     120,   74, (QMetaType::QReal << 24) | 0x00495103,
...
const QMetaObject QDeclarativeSpringAnimation::staticMetaObject = {
    { &QDeclarativeNumberAnimation::staticMetaObject, qt_meta_stringdata_QDeclarativeSpringAnimation,
      qt_meta_data_QDeclarativeSpringAnimation, 0 }
};
...
int QDeclarativeSpringAnimation::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: modulusChanged(); break;
        case 1: massChanged(); break;
        case 2: syncChanged(); break;
        default: ;
        }
        _id -= 3;
    }
