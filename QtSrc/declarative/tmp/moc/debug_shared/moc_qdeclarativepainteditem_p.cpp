...
**
** Created: Fri Sep 2 01:13:15 2011
...
static const uint qt_meta_data_QDeclarativePaintedItem[] = {
 ...
 // properties: name, type, flags
     ...
     160,  156, 0x02095103,
     180,  175, 0x01095103,
     198,  192, (QMetaType::QReal << 24) | 0x00495103,
...
const QMetaObject QDeclarativePaintedItem::staticMetaObject = {
    { &QDeclarativeItem::staticMetaObject, qt_meta_stringdata_QDeclarativePaintedItem,
      qt_meta_data_QDeclarativePaintedItem, 0 }
};
...
int QDeclarativePaintedItem::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: fillColorChanged(); break;
        case 1: contentsSizeChanged(); break;
        case 2: contentsScaleChanged(); break;
        case 3: dirtyCache((*reinterpret_cast< const QRect(*)>(_a[1]))); break;
