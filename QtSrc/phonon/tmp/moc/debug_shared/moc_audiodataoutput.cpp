...
**
** Created: Fri Sep 2 00:50:09 2011
...
const QMetaObject Phonon::AudioDataOutput::staticMetaObject = {
    { &AbstractAudioOutput::staticMetaObject, qt_meta_stringdata_Phonon__AudioDataOutput,
      qt_meta_data_Phonon__AudioDataOutput, 0 }
};
...
int Phonon::AudioDataOutput::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: dataReady((*reinterpret_cast< const QMap<Phonon::AudioDataOutput::Channel,QVector<qint16> >(*)>(_a[1]))); break;
        case 1: endOfMedia((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 2: setDataSize((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
        _id -= 3;
    }
