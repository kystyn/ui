...
**
** Created: Fri Sep 2 00:30:13 2011
...
int QAxSelect::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: on_ActiveXList_clicked((*reinterpret_cast< const QModelIndex(*)>(_a[1]))); break;
        case 1: on_ActiveXList_doubleClicked((*reinterpret_cast< const QModelIndex(*)>(_a[1]))); break;
        default: ;
        }
        _id -= 2;
    }
